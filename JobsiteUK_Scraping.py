...
for page in range(num_pages):
    ...
    # Check and click the "Next" button to go to the next page (if not the last page)
    if page < num_pages - 1:  # Don't click "Next" on the last page
        try:
...
print(f"Data from the first {num_pages} pages has been saved to scraped_jobs.csv")
